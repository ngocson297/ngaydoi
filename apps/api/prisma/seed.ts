...
async function main(): Promise<void> {
  ...
  const planDefinitions = [
    ...
    { code: "STARTER" as const, name: "Cơ bản", description: "Thiệp cưới gọn nhẹ với nhiều phong cách Việt, hiện đại và lãng mạn.", priceAmount: 199000, guestLimit: 100, mediaLimit: 20, templateKeys: ["classic-wine", "garden-sage", "blush-romance", "modern-noir", "ocean-minimal", "lotus-vietnamese", "imperial-red", "ivory-gold"], customDomain: false, prioritySupport: false, requiresPublishReview: false, sortOrder: 1 },
    { code: "STANDARD" as const, name: "Tiêu chuẩn", description: "Đầy đủ RSVP, khách mời, album và thư viện template mở rộng.", priceAmount: 399000, guestLimit: 350, mediaLimit: 80, templateKeys: ["classic-wine", "garden-sage", "blush-romance", "modern-noir", "ocean-minimal", "lotus-vietnamese", "imperial-red", "ivory-gold", "lavender-dream", "terracotta-sunset", "pearl-minimal", "midnight-blue", "tropical-palm", "cherry-blossom", "rustic-kraft", "art-deco-emerald"], customDomain: false, prioritySupport: true, requiresPublishReview: true, sortOrder: 2 },
    { code: "PREMIUM" as const, name: "Cao cấp", description: "Toàn bộ 24 template, custom domain và hỗ trợ ưu tiên.", priceAmount: 699000, guestLimit: 1000, mediaLimit: 250, templateKeys: ["classic-wine", "garden-sage", "blush-romance", "modern-noir", "ocean-minimal", "lotus-vietnamese", "imperial-red", "ivory-gold", "lavender-dream", "terracotta-sunset", "pearl-minimal", "midnight-blue", "tropical-palm", "cherry-blossom", "rustic-kraft", "art-deco-emerald", "champagne-glow", "celestial-night", "coastal-sand", "tea-ceremony", "monochrome-editorial", "peach-bloom", "heritage-indigo", "botanical-white"], customDomain: true, prioritySupport: true, requiresPublishReview: true, sortOrder: 3 },
  ];
