...
> **Delivery status 2026-08-05:** Release Phase 1 đến Phase 14 đã được triển khai trong source. Phiên bản hiện tại là **v0.14.0 — Template Library, Theme Marketplace & Final Product Polish**, sau các mốc production readiness, pilot, growth, partner portal, event operations và shared memories.
...
| Trạng thái hiện tại | v0.14.0 đã mở rộng lên 24 template, bổ sung catalog/filter/entitlement guard và hoàn thiện Home/UI; cần xác nhận build và smoke test trên môi trường máy người dùng trước production thật |
